...
func outputWithZodiacSign(p Person) {
	...
	if (p.Month == 12 && p.Day >= 1 && p.Day <= 21) || (p.Month == 11 && p.Day >= 22 && p.Day <= 30) {
		zodiacSign = Sagittarius
	} else if (p.Month == 9 && p.Day >= 1 && p.Day <= 22) || (p.Month == 8 && p.Day >= 23 && p.Day <= 31) {
		zodiacSign = Virgo
	} else if (p.Month == 2 && p.Day >= 1 && p.Day <= 18) || (p.Month == 1 && p.Day >= 20 && p.Day <= 31) {
		zodiacSign = Aquarius
	} else if (p.Month == 5 && p.Day >= 1 && p.Day <= 20) || (p.Month == 4 && p.Day >= 20 && p.Day <= 30) {
		zodiacSign = Taurus
	} else if (p.Month == 6 && p.Day >= 21 && p.Day <= 30) || (p.Month == 7 && p.Day >= 1 && p.Day <= 22) {
		zodiacSign = Cancer
	}
