...
func outputWithZodiacSign(p Person) {
	...
	if (p.Month == 3 && p.Day >= 21) || (p.Month == 4 && p.Day < 21) {
		...
		zodiacSign = Gemini
	} else if (p.Month == 6 && p.Day >= 22) || (p.Month == 7 && p.Day < 24) {
		zodiacSign = Cancer
	} else if (p.Month == 7 && p.Day >= 24) || (p.Month == 8 && p.Day < 24) {
		zodiacSign = Leo
	} else if (p.Month == 8 && p.Day >= 24) || (p.Month == 9 && p.Day < 24) {
		zodiacSign = Virgo
	} else if (p.Month == 9 && p.Day >= 24) || (p.Month == 10 && p.Day < 24) {
		zodiacSign = Libra
	...
	} else if (p.Month == 1 && p.Day >= 21) || (p.Month == 2 && p.Day < 21) {
		zodiacSign = Aquarius
	} else if (p.Month == 2 && p.Day >= 20) || (p.Month == 3 && p.Day < 21) {
		zodiacSign = Pisces
	}
